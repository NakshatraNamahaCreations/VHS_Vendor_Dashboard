...
function WhatsappAndPhone() {
  ...
  const getAllNumbers = async () => {
    let res = await axios.get(
      "https://api.vijayhomesuperadmin.in/api/getwhatsvendorNumbers"
    );
    if (res.status === 200) {
      console.log(res);
  ...
  const editNumbers = async (e) => {
    ...
    try {
      const config = {
        url: `/updateWhatsAppvendorNumber/${editNumberData._id}`,
        method: "put",
        baseURL: "https://api.vijayhomesuperadmin.in/api",
  ...
  const deleteNumbers = async (id) => {
    axios({
      method: "delete",
      url: "https://api.vijayhomesuperadmin.in/api/deletevendornumbers/" + id,
    })
              ...
              <div className="card-body p-3">
                <form>
                  ...
                  <div className="row pt-3 justify-content-center">
                    <div className="col-md-2">
                      <button className="vhs-button" onClick={addNumbers}>
                        Add
                      </button>
                    </div>
                  </div>
          ...
          <Modal.Body>
            <div className="card-body p-3">
              <form>
                ...
                <div className="row pt-3 justify-content-center">
                  <div className="col-md-2">
                    <button className="vhs-button" onClick={editNumbers}>
                      Update
                    </button>
                  </div>
                </div>
